...
from config.settings.components.common import INSTALLED_APPS, MIDDLEWARE, TEMPLATES
...
CSRF_TRUSTED_ORIGINS = [
    'https://*.collectives.pro',
    'https://*.codemia.dev',
    'https://collectives.loca.lt',
]
